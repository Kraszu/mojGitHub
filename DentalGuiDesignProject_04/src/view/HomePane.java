...
public class HomePane extends BorderPane {
	...
	public HomePane() {
		...
		tabPatient.setStyle("-fx-font-size: 10pt;-fx-background-color: #0066cc;" + "-fx-font-weight: bold;");

		Tab tabInvoice = new Tab();
		tabInvoice.setText("Invoice/Procedure Management Section");
		tabInvoice.setContent(new InvoiceProcedure());
		tabInvoice.setStyle("-fx-font-size: 10pt;-fx-background-color: #0066cc;" + "-fx-font-weight: bold;");

		Tab tabPay = new Tab();
		tabPay.setText("Payment Management Section");
		tabPay.setContent(new PaymentManagement());
		tabPay.setStyle("-fx-font-size: 10pt;-fx-background-color: #0066cc;" + "-fx-font-weight: bold;");
		// add tabs to tabpane
